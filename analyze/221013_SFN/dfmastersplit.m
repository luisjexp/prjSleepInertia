function df_new = dfmastersplit(DF, cogtask, condition_set, fsband, run_set, opts)
    ...
    if ~isempty(d2cprop_set)
        ...
        df_d2c_mu = table(df_d2c_mu./numel(ntwprops_set),'VariableNames',{'d2c_mean'});
        df_new = cat(2,df_gpsd,df_clust,df_betw,df_deg_w,df_d2c_mu,df_d2c);
    end
